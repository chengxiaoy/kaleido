...
if __name__ == "__main__":
    ...
    g = Generator(z_dim=512, c_dim=0, w_dim=512, img_resolution=resolution, img_channels=img_channels,
                  synthesis_kwargs=synthesis_kwargs, mapping_kwargs=mapping_kwargs)
    z = torch.randn(batch_size,512)
    imgs = g(z,c = None)

    d = Discriminator(c_dim=0, img_resolution=resolution, img_channels=img_channels,
